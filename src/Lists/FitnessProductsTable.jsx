...
const FitnessProductsTable = () => {
  ...
  return (
    <div>
      <h2 style={{ textAlign: 'center', marginTop: '20px' }}>Fitness Products</h2>
      ...
      {!loading && !error && products.length === 0 && (
        <p style={{ textAlign: 'center', marginTop: '20px' }}>No Fitness products found.</p>
      )}
    </div>
  );
};

export default FitnessProductsTable;
