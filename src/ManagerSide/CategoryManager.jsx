...
const CategoryManager = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editingId) {
                await axios.put(`http://https://healupbackend-production.up.railway.app/api/categories/${editingId}`, data, {
                    headers: { 'Content-Type': 'multipart/form-data' }
                });
            } else {
                await axios.post('http://https://healupbackend-production.up.railway.app/api/categories', data, {
                    headers: { 'Content-Type': 'multipart/form-data' }
                });
            }
    ...
    const handleEdit = async (id) => {
        try {
            const response = await axios.get(`http://https://healupbackend-production.up.railway.app/api/categories/${id}`);
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await axios.delete(`http://https://healupbackend-production.up.railway.app/api/categories/${id}`);
            fetchCategories();
        } catch (err) {
            console.error(err);
                                ...
                                {categories.map((cat, index) => (
                                    ...
                                    >
                                        ...
                                        <td style={styles.td}>
                                            {cat.category_image && (
                                                <img
                                                    src={`http://https://healupbackend-production.up.railway.app/uploads/${cat.category_image}`}
