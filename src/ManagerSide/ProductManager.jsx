...
const ProductManager = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editingId) {
                await axios.put(`https://heal-up-backend-pi.vercel.app/api/products/${editingId}`, data, {
                    headers: { 'Content-Type': 'multipart/form-data' }
                });
            } else {
                await axios.post('https://heal-up-backend-pi.vercel.app/api/products', data, {
                    headers: { 'Content-Type': 'multipart/form-data' }
                });
            }
    ...
    const handleEdit = async (id) => {
        try {
            const response = await axios.get(`https://heal-up-backend-pi.vercel.app/api/products/${id}`);
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await axios.delete(`https://heal-up-backend-pi.vercel.app/api/products/${id}`);
            fetchProducts();
        } catch (err) {
            console.error(err);
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <td style={styles.td}>
                                                    {prod.image && (
                                                        <img 
                                                            src={`https://heal-up-backend-pi.vercel.app/uploads/${prod.image}`} 
