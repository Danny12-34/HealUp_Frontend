...
const ProductManager = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editingId) {
                await axios.put(`https://healupbackend-production.up.railway.app/api/products/${editingId}`, data, {
                    headers: { 'Content-Type': 'multipart/form-data' }
                });
            } else {
                await axios.post('https://healupbackend-production.up.railway.app/api/products', data, {
                    headers: { 'Content-Type': 'multipart/form-data' }
                });
            }
    ...
    const handleEdit = async (id) => {
        try {
            const response = await axios.get(`https://healupbackend-production.up.railway.app/api/products/${id}`);
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await axios.delete(`https://healupbackend-production.up.railway.app/api/products/${id}`);
            fetchProducts();
        } catch (err) {
            console.error(err);
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <td style={styles.td}>
                                                    {prod.image && (
                                                        <img 
                                                            src={`https://healupbackend-production.up.railway.app/uploads/${prod.image}`} 
