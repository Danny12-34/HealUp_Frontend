...
export default function CasesManager() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingCaseId) {
        await axios.put(`https://heal-up-backend-pi.vercel.app/api/cases/${editingCaseId}`, { case_name: caseName });
      } else {
        await axios.post("https://heal-up-backend-pi.vercel.app/api/cases", { case_name: caseName });
      }
      setCaseName("");
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://heal-up-backend-pi.vercel.app/api/cases/${id}`);
      fetchCases();
    } catch (err) {
